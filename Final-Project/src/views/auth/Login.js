                ...
                <chakra.form onSubmit={onSubmitHandle} >
                    <Flex direction="column" experimental_spaceY="3">
                        <FormControl id="email">
                            ...
                            <Input type="email" name="email" required value={credentials.email} onChange={onHandleChange} />
                        </FormControl>
                        <FormControl id="password">
                            <FormLabel>Password</FormLabel>
                            <Input type="password" name="password" required value={credentials.password} onChange={onHandleChange} />
                        </FormControl>
                        <br />
